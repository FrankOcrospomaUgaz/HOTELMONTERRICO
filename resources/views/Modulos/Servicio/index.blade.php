...
<section class="cajaAlrededor">
    ...
    <div class="mb-1">
        <div style="float:left">
            ...
            <a href="#" id="btonNuevo" class="btn btn-primary btonNuevo btn-sm">NUEVO SERVICIO</a>
            @include('Modulos.Servicio.Modals.modalCrearServicio')
            @endcan
        </div>
        <form id="filtro">
    ...
    @include('Modulos.Servicio.Tables.tablaServicio')

</section>
@can($permisosEditar->name)
@include('Modulos.Servicio.Modals.modalEditarServicio')
@endcan
...
<script src="{{ asset('js/JqueryServicio/JqueryIndexServicio.js') }}"></script>

@can($permisosEliminar->name)
<script src="{{ asset('js/JqueryServicio/JqueryDestroyServicio.js') }}"></script>
@endcan


@can($permisosCrear->name)
<script src="{{ asset('js/JqueryServicio/JqueryCreateServicio.js') }}"></script>
@endcan

@can($permisosEditar->name)
<script src="{{ asset('js/JqueryServicio/JqueryEditServicio.js') }}"></script>
<script src="{{ asset('js/JqueryServicio/JqueryUpdateServicio.js') }}"></script>
@endcan
