...
<div class="mb-1">
    <div style="float:left">
        ...
        <a href="#" id="btonNuevoProducto" class="btn btn-primary btonNuevo btn-sm">NUEVO PRODUCTO</a>
      
        @endcan
    </div>
    <form id="filtroProducto">
        <div class="enviaFiltro" style="float:right">
            <span id="resetFiltroProducto" class="btn btn-dark ml-1" style="font-size:14px;width:55px">
        ...
        <div style="float:right" class="mt-2">
            <select id="activosProducto" class="form-control activos selectActivos btn-sm">
