...
<section class="cajaAlrededor">
    ...
    <div class="mb-1">
        <div style="float:left">
            ...
            <a href="#" id="btonNuevo" class="btn btn-primary btonNuevo btn-sm">NUEVO ROL</a>
            @include('Modulos.RolPersona.Modals.modalCrearRolPersona')
            @endcan
        </div>
        <form id="filtro">
    ...
    @include('Modulos.RolPersona.Tables.tablaRolPersona')
</section>

@can($permisosEditar->name)
@include('Modulos.RolPersona.Modals.modalEditarRolPersona')
@endcan
...
<script src="{{ asset('js/JqueryRolPersona/JqueryIndexRolPersona.js') }}"></script>

@can($permisosEliminar->name)
<script src="{{ asset('js/JqueryRolPersona/JqueryDestroyRolPersona.js') }}"></script>
@endcan


@can($permisosCrear->name)
<script src="{{ asset('js/JqueryRolPersona/JqueryCreateRolPersona.js') }}"></script>
@endcan

@can($permisosEditar->name)
<script src="{{ asset('js/JqueryRolPersona/JqueryEditRolPersona.js') }}"></script>
<script src="{{ asset('js/JqueryRolPersona/JqueryUpdateRolPersona.js') }}"></script>
@endcan
