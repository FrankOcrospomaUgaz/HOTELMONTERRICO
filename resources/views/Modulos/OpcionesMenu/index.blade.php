...
@section('content_header')
    <br><br>
    <!-- <h1 id="titulo" class="text-center">OPCIONES DE MENU</h1> -->
@stop
...
@section('content')
    <section class="cajaAlrededor">
        ...
        <div class="mb-2">
            <div style="float:left">
                @can($permisosCrear->name)
                    <a href="#" id="btonNuevo" class="btn btn-primary btonNuevo btn-sm">NUEVA OPCION</a>
                    @include('Modulos.OpcionesMenu.Modals.modalCrearOpcion')
                @endcan
            </div>
            <form id="filtro">
        ...
        @include('Modulos.OpcionesMenu.Tables.tablaOpciones')
...
@can($permisosEditar->name)
    @include('Modulos.OpcionesMenu.Modals.modalEditarOpcion')
    @include('Modulos.OpcionesMenu.Modals.modalOpcionesCRUD')
    @include('Modulos.OpcionesMenu.Modals.modalEditarOpcionCRUD')
@endcan
...
<script src="{{ asset('js/JqueryOpciones/JqueryIndexOpciones.js') }}"></script>

@can($permisosEliminar->name)
    <script src="{{ asset('js/JqueryOpciones/JqueryDestroyOpciones.js') }}"></script>
@endcan


@can($permisosCrear->name)
    <script src="{{ asset('js/JqueryOpciones/JqueryCreateOpciones.js') }}"></script>
@endcan

@can($permisosEditar->name)
    <script src="{{ asset('js/JqueryOpciones/JqueryEditOpciones.js') }}"></script>
    <script src="{{ asset('js/JqueryOpciones/JqueryUpdateOpciones.js') }}"></script>
@endcan
