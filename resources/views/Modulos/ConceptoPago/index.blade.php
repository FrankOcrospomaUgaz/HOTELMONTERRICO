...
@section('title', 'CONCEPTO PAGO')

@section('content_header')
<br><br>
<!-- <h1 id="titulo" class="text-center">ROLES DE PERSONA</h1> -->
@stop
...
<section class="cajaAlrededor">
    ...
    <div class="mb-1">
        <div style="float:left">
            ...
            <a href="#" id="btonNuevo" class="btn btn-primary btonNuevo btn-sm">NUEVO CONCEPTO</a>
            @include('Modulos.ConceptoPago.Modals.modalCrearConceptoPago')
            @endcan
        </div>
        <form id="filtro">
    ...
    @include('Modulos.ConceptoPago.Tables.tablaConceptoPago')
</section>
...
@include('Modulos.ConceptoPago.Modals.modalEditarConceptoPago')
@endcan
...
<script src="{{ asset('js/JqueryConceptoPago/JqueryIndexConceptoPago.js') }}"></script>

@can($permisosEliminar->name)
<script src="{{ asset('js/JqueryConceptoPago/JqueryDestroyConceptoPago.js') }}"></script>
@endcan


@can($permisosCrear->name)
<script src="{{ asset('js/JqueryConceptoPago/JqueryCreateConceptoPago.js') }}"></script>
@endcan

@can($permisosEditar->name)
<script src="{{ asset('js/JqueryConceptoPago/JqueryEditConceptoPago.js') }}"></script>
<script src="{{ asset('js/JqueryConceptoPago/JqueryUpdateConceptoPago.js') }}"></script>
@endcan
