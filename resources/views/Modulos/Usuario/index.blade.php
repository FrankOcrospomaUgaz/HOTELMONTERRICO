...
@section('content_header')
    <br><br>
    <!-- <h1 id="titulo" class="text-center">PERSONAS</h1> -->
@stop
...
@section('content')
    ...
    <section class="cajaAlrededor">
        <div class="mb-1">
            <div style="float:left">
                @can($permisosCrear->name)
                    <a href="#" id="btonNuevo" class="btn btn-primary btn-sm">NUEVA PERSONA</a>
                    @include('Modulos.Usuario.Modals.modalCrearUsuario')
                @endcan
            </div>
            <form id="filtro">
                ...
                <div style="float:right" class=" btn-sm">
                    <select id="activos" class="form-control selectActivos activos">
        ...
        @include('Modulos.Usuario.Tables.tablaUsuario')
    </section>




    @include('Modulos.Usuario.Modals.modalEditarUsuario')
...
<script src="{{ asset('js/JqueryUsuario/JqueryIndexUsuario.js') }}"></script>

@can($permisosEliminar->name)
    <script src="{{ asset('js/JqueryUsuario/JqueryDestroyUsuario.js') }}"></script>
@endcan
...
@can($permisosEditar->name)
    <script src="{{ asset('js/JqueryUsuario/JqueryEditUsuario.js') }}"></script>
    <script src="{{ asset('js/JqueryUsuario/JqueryUpdateUsuario.js') }}"></script>
@endcan
