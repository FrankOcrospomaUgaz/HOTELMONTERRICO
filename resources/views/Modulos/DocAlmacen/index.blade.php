...
@section('title', 'DOCUMENTO DE ALMACEN')

@section('content_header')
<br><br>
<!-- <h1 id="titulo" class="text-center">COMPRAS</h1> -->
@stop
...
<section class="cajaAlrededor">
    <div class="mb-2">
        <div style="float:left">
            ...
            <a href="#" id="btonNuevo" class="btn btn-primary btonNuevo btn-sm">NUEVO DOCUMENTO</a>

            @endcan
        </div>
        <form id="filtro">
            <div class="enviaFiltro" style="float:right">
                <a id="resetFiltro" class="selectActivos btn btn-sm btn-dark" style="font-size:12px;width:62px; background-color:black">
            ...
            <div class="centrarFechas">
                <input type="text" id="calendarioInicio" class="selectActivos btn-sm mt-2" placeholder="Fecha Inicio">
                <input type="text" id="calendarioFin" class="selectActivos btn-sm mt-2" placeholder="Fecha Fin">
            </div>
        </form>
    </div>
    @include('Modulos.DocAlmacen.Tables.tablaDocAlmacen')
</section>
...
<script src="{{ asset('js/JqueryDocAlmacen/JqueryIndexAlmacen.js') }}"></script>
