                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group ajuste">
                                            ...
                                            <input type="number" class="form-control text-left" name="dni" id="dni" min="0" onkeypress="return event.keyCode != 13;">
                                            <div class="input-group-append">
                                                <span id="dniBuscar" class="input-group-text"><i class="fa-solid fa-magnifying-glass"></i></span>
                                            </div>
