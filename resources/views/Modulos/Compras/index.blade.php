        ...
        <div class="mb-2">
            <div style="float:left">
                @can($permisosCrear->name)
                    <a href="#" id="btonNuevo" class="btn btn-primary btonNuevo btn-sm">NUEVO <b><i
                                class="fa-solid fa-plus"></i></b> </a>
                @endcan
            </div>
            <form id="filtro">
                ...
                <div class="centrarFechas">
                    <input type="text" id="calendarioInicio" class="selectActivos btn-sm mt-2"
                        placeholder="Fecha Inicio">
                    <input type="text" id="calendarioFin" class="selectActivos btn-sm mt-2" placeholder="Fecha Fin">
                </div>
            </form>
        </div>
        @include('Modulos.Compras.Tables.tablaCompras')
    </section>
...
@section('js')
    ...
    <script src="{{ asset('js/JqueryCompras/JqueryIndexCompras.js') }}"></script>
    ...
    <script src="{{ asset('js/JqueryCompras/JqueryEditCompras.js') }}"></script>
    <script src="{{ asset('js/JqueryCompras/JqueryUpdateCompras.js') }}"></script> --}}
