...
@section('title', 'REPORTES DE CIERRE DE CAJA')
...
<section class="cajaAlrededor">
    ...
    <div class="tablaContainer">
        ...
        <br>
        @include('Modulos.Reportes.Tables.tablaReporteCierre')
...
<script src="{{ asset('js/JqueryReporteCierre/JqueryIndexReporteCierre.js') }}"></script>
<script src="{{ asset('js/JqueryReporteCierre/JqueryReportes.js') }}"></script>
