$(document).ready(function () {
    $("#tituloPagina").html(
        `<a class="nav-link active" href="categoriaMenu">HOTEL | GRUPO MENU</a>`
    );
    $("#stockProductos").html(
...
$("#filtro").submit(function (e) {
    ...
    $("#tbCategoriaMenu").dataTable().fnDestroy();
    var table = $("#tbCategoriaMenu").DataTable({
        ajax: {
            url: "categoriaMenu",
            data: {
                estado: $("#activos").val(),
...
$(document).on("click", "#cerrarModal", function () {
    $("#modalCrearGrupoMenu").modal("hide");
});

$(document).on("click", "#cerrarModalEGrupo", function () {
    $("#modalEditarGrupoMenu").modal("hide");
});
...
var butomns = [
    {
        ...
        exportOptions: {
            columns: [0, 1, 3], // las columnas que se exportarán
        },
    },
    {
        extend: "csv",
...
$("#tbCategoriaMenu thead tr")
    .clone(true)
    .addClass("filters")
    .appendTo("#tbCategoriaMenu thead");
