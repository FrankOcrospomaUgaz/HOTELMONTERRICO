...
$(document).ready(function () {
    ...
    $("#registroHabitacion")[0].reset(); //limpiar campos

    $("#registroHabitacion").submit(function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response) {
                    ...
                    $("#modalHabitacion").modal("hide"); //ocultar modal
                } else {
                    alert("nO");
                }
            },
