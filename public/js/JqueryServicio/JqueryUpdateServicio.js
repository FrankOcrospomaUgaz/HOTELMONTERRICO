...
$(document).ready(function () {
    $("#registroServicioE").submit(function (e) {
        e.preventDefault();
        ...
        $.ajax({
            type: "POST",
            url: "catServicios/editar/" + $("#idE").val(),
            data: formData,
            processData: false,
            contentType: false,
            success: function (response) {
                if (response) {
                    ...
                    $("#tbServicio").DataTable().ajax.reload(); //recargar datatable
                    $("#modalServicioE").modal("hide"); //ocultar modaL
                } else {
                    alert("nO");
                }
            },
