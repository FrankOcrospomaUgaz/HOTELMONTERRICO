$(document).ready(function () {
    $("#tituloPagina").html(
        `<a class="nav-link active" href="catServicios">HOTEL | SERVICIOS</a>`
    );
    $("#stockProductos").html(
...
$("#filtro").submit(function (e) {
    ...
    $("#tbServicio").dataTable().fnDestroy();

    var table = $("#tbServicio").DataTable({
        ajax: {
            url: "catServicios",
            data: {
                estado: $("#activos").val(),
