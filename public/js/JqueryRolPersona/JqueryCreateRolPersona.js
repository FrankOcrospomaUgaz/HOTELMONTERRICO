...
$(document).ready(function () {
    ...
    $("#registroRolPersona")[0].reset(); //limpiar campos

    $("#registroRolPersona").submit(function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response) {
                    ...
                    $("#modalRolPersona").modal("hide"); //ocultar modal
                } else {
                    alert("nO");
                }
            },
